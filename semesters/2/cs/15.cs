    ...
    private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                y = i + k;
                if ((i >= 8) && (i <= 10)) { y = Nechit_15.Factorial.funcFactorial(i - 7); }
                else if (i > 12 && i <= 20) { y = Nechit_15.Factorial.funcFactorial(i - 11); }
...
namespace Nechit_15
{
    ...
    {
        public static int funcFactorial(int x)
        {
            if (x == 0) { return 1; }
            else { return x * funcFactorial(x - 1); }
        }
    }
}
